...
'''
'''
14. Authentication and Permission Classes. 
'''
class StudentModelViewSet(viewsets.ModelViewSet): 
        queryset = Student.objects.all()
        serializer_class = StudentSerializer
        
        # We can individually use auth and permission classes 
        # If global auth and permisson classes is defined, then the view is auto applied the global auth and permission settings 
        # Or we can override the global auth and permission setting setting auth and permission locally. 
        # See the default auth and permission classes settings in settings.py 
