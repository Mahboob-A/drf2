...
from .models import Song, Album, Student 
...
class StudentSerializer(serializers.HyperlinkedModelSerializer): 
        class Meta: 
                model = Student 
                fields = ['id', 'url', 'name', 'roll',]  # url fields will be auto generated using the HyperlinkedModelserializer 
                # this url will hold the "detail" of the object. 
