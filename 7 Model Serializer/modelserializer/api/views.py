...
class StudentAPI(View): 
        def get(self, request, *args, **kwargs): 
                ...
                if roll is not None: 
                        # serialization : complex to json (no try and except block added to validate if the object is present in the database)
        ...
        def put(self, request, *args, **kwargs): 
                ...
                # get the student model object using the roll (no try except block is implemented if invalid or not existed roll is passed)
                single_student_data = Student.objects.get(roll=roll)
